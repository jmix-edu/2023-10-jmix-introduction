 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "tm_MainScreen", screenBasePackages = "com.company.taskmanagement.screen")
@ContextConfiguration(classes = {TaskmanagementApplication.class, UiTestAssistConfiguration.class})
